...
@interface DetailViewController : UIViewController <OpenEarsEventsObserverDelegate,UISplitViewControllerDelegate, ISpeechDelegate,UIAlertViewDelegate,MBProgressHUDDelegate,UIWebViewDelegate,AVAudioPlayerDelegate,ASIHTTPRequestDelegate> {
...
@property (nonatomic, retain) IBOutlet UITextView *recipeTextView;
...
@property (nonatomic, retain) id <ISpeechDelegate> delegate;
@property (nonatomic,retain) MyGeniScheduler *myGeni;
@property (nonatomic,retain) IBOutlet UILabel *timerLabel;
@property (nonatomic,retain)    AVAudioPlayer *av;
@property (nonatomic,retain) NSString *heardText;
@property (nonatomic,retain) UIAlertView *alert;
@property (nonatomic,retain) NSString *flagStr;
@property (nonatomic,assign) float tempTime;
@property (nonatomic,assign) BOOL isTimerActivatingSpeech;
@property (nonatomic,assign) BOOL isListeningActivatingSpeech;
@property (nonatomic,assign) BOOL isSpeakingActivationSpeech;
@property (nonatomic,assign) BOOL isQuestionActivationSpeech;
@property (nonatomic,assign) BOOL isFinishedCooking;
@property (nonatomic,retain) NSTimer *myTimer;
@property (nonatomic, retain) MBProgressHUD *progressHud;
@property (nonatomic,retain)     IBOutlet UIImageView *listenImageView;
@property (nonatomic,assign) BOOL isInitializing;
@property (nonatomic,retain) NSTimer *questionTimer;
@property  int numberOfQuestion;
@property (nonatomic,retain) NSString *code;
@property (nonatomic,retain) NSArray *rowArray;
@property(nonatomic,retain) NSTimer *listeningTimer;
@property(nonatomic,retain) NSTimer *speakingTimer;
@property(nonatomic,retain) NSString *recentAnswer;
@property(assign)BOOL ynMatched;
@property(nonatomic,retain) CartViewController *cartVC;
...
@property BOOL proximityCheckEnabled;
@end
