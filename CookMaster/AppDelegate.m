...
- (void)dealloc
{
    ...
    [self setAudioSessionManager:nil];
...
*/
    ...
    if ([AppDelegate hasConnectivity]==NO) {
        UIAlertView *alert=[[UIAlertView alloc]initWithTitle:@"네트워크"  message:@"네트웍 연결이 불안정합니다. 네트웍이 안정된 곳에서 실행해 주세요" delegate:nil cancelButtonTitle:@"승인" otherButtonTitles:nil, nil];
        [alert show];
    } 
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone) {
       ...
       // self.navigationController.navigationBar.tintColor = [UIColor colorWithRed:0.9607 green:0.5568 blue:0.2705 alpha:1.0];
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"CookMaster" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"CookMaster.sqlite"];
